...
- reject: anything unrelated to movies
...
COMMON_CREW_JOBS = [
    "Director", "Producer", "Executive Producer", "Screenplay", "Writer",
    "Editor", "Director of Photography", "Original Music Composer",
    "Production Design", "Art Direction", "Costume Design", "Casting",
]
